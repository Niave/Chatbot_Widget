(()=>{window.initChatbot=function(r={}){if(window.chatbotInitialized)return;window.chatbotInitialized=!0;let{botName:N=r.botName||"X",assistantTitle:A=r.assistantTitle||"AI Assistent - X",greetingHTML:$=r.greetingHTML||`
